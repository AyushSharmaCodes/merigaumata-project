-- Migration: Update Product RPC Functions for category_id support
-- Created: 2026-02-05

-- ============================================================================
-- 1. CREATE PRODUCT WITH VARIANTS (Updated for category_id)
-- ============================================================================
...
BEGIN
    ...
    INSERT INTO products (
        ...
        (p_product_data->>'category_id')::uuid, -- Added
...
-- ============================================================================
-- 2. UPDATE PRODUCT WITH VARIANTS (Updated for category_id)
-- ============================================================================
...
BEGIN
    ...
    UPDATE products SET
        ...
        category_id = COALESCE((p_product_data->>'category_id')::uuid, category_id), -- Added
