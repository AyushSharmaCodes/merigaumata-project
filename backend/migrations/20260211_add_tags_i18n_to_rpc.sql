-- Migration: Update Product RPC Functions to handle tags_i18n
-- Created: 2026-02-11

-- ============================================================================
-- 1. CREATE PRODUCT WITH VARIANTS (Updated for tags_i18n)
-- ============================================================================
...
BEGIN
    ...
    INSERT INTO products (
        ...
        COALESCE(p_product_data->'tags_i18n', '{}'::jsonb), -- Added
        COALESCE(
...
-- ============================================================================
-- 2. UPDATE PRODUCT WITH VARIANTS (Updated for tags_i18n)
-- ============================================================================
...
BEGIN
    ...
    UPDATE products SET
        ...
        tags = CASE 
            ...
            ELSE tags 
        END,
        tags_i18n = COALESCE(p_product_data->'tags_i18n', tags_i18n), -- Added
        benefits = CASE 
