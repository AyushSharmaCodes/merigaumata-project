-- Migration: Finalize Dashboard Revenue Calculation
-- Created: 2026-04-01
-- Description:
-- Restores the intended final dashboard RPC behavior after the same-day follow-up
-- migration overwrote the net-revenue logic. Net revenue should include paid-like
-- orders and subtract processed refunds.
