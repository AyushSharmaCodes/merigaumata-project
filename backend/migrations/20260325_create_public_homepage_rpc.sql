-- Aggregate homepage bootstrap content in a single DB round trip.
-- Use targeted joins for related records and guard optional tables so
-- older environments can still run the function.
