-- Migration: Fix Dashboard RPC Signature
-- Description: Drops the outdated 2-parameter signature and ensures the 7-parameter version is active.
-- Created: 2026-04-18

-- 1. Drop the outdated signature to avoid confusion/overloading issues
DROP FUNCTION IF EXISTS public.get_admin_dashboard_stats_v3(TIMESTAMPTZ, TIMESTAMPTZ);

-- 2. Create/Replace the correct 7-parameter version
