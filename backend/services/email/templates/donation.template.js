...
const { buildGreeting, firstNonEmpty, formatCurrency, formatDate, buildActionButton } = require('./template.utils');
...
function getDonationReceiptEmail({ donation, donorName, isAnonymous = false }) {
    ...
    const content = `
        ...
        <div class="panel panel-success">
            ...
            <p>Amount: ${formatCurrency(donation?.amount)}</p>
...
function getSubscriptionConfirmationEmail({ subscription, donorName, isAnonymous = false }) {
    ...
    const content = `
        ...
        <div class="panel panel-success">
            ...
            <p>Amount: ${formatCurrency(subscription?.amount)}</p>
