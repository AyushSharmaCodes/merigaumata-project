...
import { 
  ...
  Download, ChevronDown, MessageSquare, Loader2
} from 'lucide-react';
...
} from '@/shared/components/ui/page-skeletons';
...
import {
  DropdownMenu as DropdownMenuOriginal,
  DropdownMenuContent as DropdownMenuContentOriginal,
  DropdownMenuItem as DropdownMenuItemOriginal,
  DropdownMenuTrigger as DropdownMenuTriggerOriginal,
} from "@/shared/components/ui/dropdown-menu";

const DropdownMenu = DropdownMenuOriginal;
const DropdownMenuContent = DropdownMenuContentOriginal;
const DropdownMenuItem = DropdownMenuItemOriginal;
const DropdownMenuTrigger = DropdownMenuTriggerOriginal;
            ...
            <div className="p-8 py-6 border-t border-border/20 flex items-center justify-between bg-white/30">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button 
                  ...
                  size="icon" 
                  className="h-9 w-9 rounded-xl bg-white/70 border-none shadow-sm disabled:opacity-30 hover:bg-white transition-all"
                  onClick={() => setOrdersPage((p: number) => p + 1)}
