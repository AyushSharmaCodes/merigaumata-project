...
import type { UserOrderDetailOrder, UserOrderDetailItem } from "@/domains/order/model/user-order-detail.types";
...
export const OrderDetailSummary: React.FC<OrderDetailSummaryProps> = ({ 
    ...
    const subtotalIsInclusive = order.items?.every((item: UserOrderDetailItem) => item.price_includes_tax !== false) ?? true;
