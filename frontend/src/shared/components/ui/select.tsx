...
>(({ className, children, ...props }, ref) => {
  const inferredAriaLabel = React.Children.toArray(children).reduce<string | undefined>((label, child) => {
    if (label || !React.isValidElement(child)) return label;
    const placeholder = (child.props as { placeholder?: unknown }).placeholder;
    return typeof placeholder === "string" ? placeholder : label;
  }, props["aria-label"]);
