import type { CartResponse, CartItem } from "./cart.types";
...
export class CartDTO {
     ...
     */
    static fromResponse(response: CartResponse): { items: CartItem[], totals: CartResponse['totals'], deliverySettings?: any } {
        return {
            items: this.toCartItems(response),
            totals: response.totals,
            deliverySettings: (response.totals as any).deliverySettings
        };
    }
}
