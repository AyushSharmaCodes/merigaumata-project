        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 flex flex-col gap-8">
            ...
            <div className="bg-[#fcfaf5] rounded-2xl p-6 border border-[#f3ead8] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex flex-col gap-1">
                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Scheduled Date & Time</span>
                    <span className="text-base font-bold text-slate-800">
                        {/* derivation logic or mock as per screenshot */}
                        Oct 28, 2023
                    </span>
                    <span className="text-sm font-bold text-emerald-600">10:00 AM - 1:00 PM</span>
                </div>
                <button className="bg-[#f3ead8] hover:bg-[#ebdcc0] text-slate-700 px-6 py-2.5 rounded-lg text-xs font-bold transition-colors">
                    Reschedule
                </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-2">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-3 mt-1">
                        <div className="w-10 h-10 rounded-full bg-[#fcfaf5] border border-[#f3ead8] text-[#cca036] flex items-center justify-center font-black text-sm">
                            R
                        </div>
                        <div className="flex flex-col">
                            <span className="text-sm font-bold text-slate-800">Ramesh Kumar</span>
                            <span className="text-[11px] text-slate-400 font-bold uppercase tracking-widest">ID: AG-8832</span>
                        </div>
                    </div>
                </div>
            </div>
